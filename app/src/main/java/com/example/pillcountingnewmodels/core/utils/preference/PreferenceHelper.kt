package com.example.pillcountingnewmodels.core.utils.preference
...
import com.example.pillcountingnewmodels.core.settings.domain.model.ColorSettings
 ...
 *
 * This class wraps [androidx.security.crypto.EncryptedSharedPreferences] to provide:
 * - Encrypted storage of authentication tokens (access/refresh).
 * - User session state (logged in, IDs).
 * - Transaction identifiers.
 * - Cached theme configuration ([com.example.pillcountingnewmodels.core.settings.domain.model.ColorSettings]) for instant UI rendering.
 *
 * ### Security
 ...
 *
 * ### Logging
 * - Operations are logged via [com.example.pillcountingnewmodels.core.utils.logger.AppLogger], but sensitive values are never logged.
...
class PreferenceHelper @Inject constructor(
    ...
    /** JSON serializer/deserializer for objects like [com.example.pillcountingnewmodels.core.settings.domain.model.ColorSettings]. */
    private val gson = Gson()

    /** Logger instance for consistent structured logging. */
    private val logger = AppLogger.Companion.create<PreferenceHelper>()
    ...
    /**
     * Saves theme [com.example.pillcountingnewmodels.core.settings.domain.model.ColorSettings] as encrypted JSON.
     *
     * @param theme The [com.example.pillcountingnewmodels.core.settings.domain.model.ColorSettings] object to persist securely.
     */
